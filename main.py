...
if __name__ == '__main__':
    ...
    files = [os.path.join(TRAIN_DATA_DIRECTORY + f"{i}", file) for i in range(5) for file in os.listdir(TRAIN_DATA_DIRECTORY + f"{i}/") if file.endswith('.mp4')][:num_videos]
